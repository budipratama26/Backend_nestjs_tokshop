...
export class QueryProductDto {
  ...
  @ApiPropertyOptional({
    example: 10,
    description: 'Jumlah barang per halaman',
  })
  @IsOptional()
  @Type(() => Number)
  ...
  @IsOptional()
  @IsIn(['id', 'name', 'price', 'quantity'], {
    message: 'sortBy hanya boleh: id, name, price, atau quantity',
  })
  sortBy?: string = 'id';
  ...
  @ApiPropertyOptional({
    ...
    enum: ['ASC', 'DESC'],
    description:
      'Arah urut: ASC (A-Z / Rendah ke Tinggi), DESC (Z-A / Tinggi ke Rendah',
  })
  @IsOptional()
  @IsIn(['ASC', 'DESC', 'asc', 'desc'], {
    message: 'order hanya boleh ASC atau DESC',
  })
  order?: 'ASC' | 'DESC' = 'DESC';
}
